...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-450 to-indigo-600 dark:from-gray-900 dark:to-gray-950 flex items-center justify-center px-4 transition-colors duration-200">
      <div className="bg-white dark:bg-gray-900 border border-transparent dark:border-gray-800 rounded-lg shadow-xl p-8 w-full max-w-md transition-colors duration-200">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-2">Sign in to your ShopMate account</p>
        </div>
        ...
        <p className="text-center mt-8 text-gray-600 dark:text-gray-400">
          New to ShopMate?{' '}
          <Link to="/register" className="text-indigo-700 dark:text-indigo-500 hover:text-orange-700 dark:hover:text-indigo-300 font-semibold">
            Create an account
          </Link>
        </p>
      </div>
